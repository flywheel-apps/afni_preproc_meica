...
def build_afni_proc_call(config):
    ...
    #     -dsets_me_run REST_cmrr_mbep2d_bold_1p5mm_3echo_10min_e1.nii.gz        \
    #     REST_cmrr_mbep2d_bold_1p5mm_3echo_10min_e2.nii.gz                      \
    #     REST_cmrr_mbep2d_bold_1p5mm_3echo_10min_e3.nii.gz -echo_times 14.0     \
    #     37.87 61.74 -reg_echo 2 -tcat_remove_first_trs 2 -align_opts_aea -cost \
    #     lpc+ZZ -tlrc_base                                                      \
    #     /usr/local/fsl/data/standard/MNI152_T1_1mm_brain.nii.gz -tlrc_NL_warp  \
    #     -volreg_align_to MIN_OUTLIER -volreg_align_e2a -volreg_tlrc_warp       \
    #     -mask_epi_anat yes -combine_method tedana -regress_motion_per_run      \
